...
### Running the API
We provide a REST API using FastAPI to easily encode and decode messages in images.
...
```
3. Open your browser and navigate to `http://127.0.0.1:8000/docs` to interact with the API endpoints (`/encode` and `/decode`) via the Swagger UI.
